class ProductsController < ApplicationController
  ...
  def product_params
    params.require(:product).permit(:name, :brand_id, :primary_category_id, :secondary_category_id, :third_category_id, :dimension, :battery, :weight, :display, :water_res, :memory, :gps, :bluetooth, :wi_fi, :os_system, :nfc, :heart_rate, :touch_screen, :voice_control, :phone_call, :offline_music, :apps, :sleep_tracking, :fitness_features, :avatar, :store_1_name, :store_1_link, :store_1_price, :store_2_name, :store_2_link, :store_2_price, :store_3_name, :store_3_link, :store_3_price, :active)
  end
end
